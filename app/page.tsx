...
export default function Home() {
    ...
    const reload = () =>{
        router.push("/admin/song-category");
    }
    return (
        <RevealSlides
            key="rs-2"
            ...
            <section key="0" data-background-color="#0c1821">
                <section key="0-0">
                    <div className="container bg-red-200 w-[300%] h-[300%] mr-200">
                        ...
                        <div>Image</div>
                        <button onClick={reload}>Here</button>
                        <div>Caption</div>
                    </div>
                </section>
                <section key="0-1">
            ...
            <section key="1" data-background-color='#bf4f41'>
                ...
                <section key="1-2">
                    <p>Simply put, React already takes care of converting JSX into something Reveal.js can work
                        with.</p>
