      ...
      >
        ...
        >
          <div style={{ position: "relative", height: "100%", width: "100%" }}>
            ...
            <img
              className={gif ? "cover-image" : "sole-image"}
              src={image}
              alt={title}
              style={{
                position: "relative",
        ...
        >
          <h4
            style={{ color: "#f17a52", textAlign: "center", fontSize: "110%" }}
          >
            {title}
          </h4>
        ...
        >
          {techStack.map((tech, i) => (
            <div
              key={i}
              style={{
                padding: "0.4rem 0.5rem 0.26rem 0.5rem",
                backgroundColor:
                  tech.split(":").length > 1 ? tech.split(":")[1] : "#f17a52",
                color: "white",
    ...
    <>
      <div
        ...
        style={{
          ...
          transition:
            headerOpacity === 0 ? "" : "opacity 0.7s ease-in-out 0.8s",
        }}
      >
        <div
          style={{
      ...
      >
        <section key="0">
          ...
          >
            ...
            >
              ...
              >
                <p className="roboto-medium">ICi</p>
              </button>
            </div>
            <p
              className="fragment fade-in-then-semi-out"
        ...
        <section key="4">
          ...
          >
            ...
            >
              <h4 style={{ color: "#f17a52", textAlign: "left" }}>Section 4</h4>
              <p style={{ textAlign: "left" }}>
                <span
                  className="fragment fade-in-then-semi-out"
                  style={{ marginLeft: "0.35rem", marginRight: "0.35rem" }}
                >
                  ...
                  >
                    ...
                    >
                      <p className="roboto-medium">Section 4</p>
                    </button>
                  </div>
                </span>
                <span
...
function Sections() {
  ...
  const handleSlideChange = (event) => {
    ...
    // console.log("Change");
    // // Vérifiez si la section clé 11 est maintenant affichée
    // // if (event.currentSlide.dataset.autoAnimate)
    //   {
    //   // Chargez les données JSON lorsque la section 11 est rendue
    //   fetch("/ressources/hira/01_fihirana_ffpm.json")
    //     .then((response) => response.json())
    //     .then((jsonData) => {
    //       setData(jsonData.fihirana["ffpm_123"].hira);
