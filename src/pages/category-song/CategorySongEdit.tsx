...
const CategorySongEdit = ({ open, setOpen, data }) => {
  ...
  const onSubmit = async (values: FormData) => {
    handleClose();
    console.log("Submieted types");
    control._reset();
    console.log(data.id,"...",values.name);
     await invoke("update_types", {
      id: data.id,
       form: {
         name: values.name
       },
  ...
  const onDelete = async (values: FormData) => {
    handleClose();
    console.log("Submieted types");
    control._reset();
    await invoke("delete_types", {
      id: data.id,
    }).then(response);
  };
...
export default CategorySongEdit;
